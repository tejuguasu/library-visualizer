...
import { itemsAdd, itemsFetch, itemsViewInOpenLibrary } from '../item/state/itemReducer';
...
const mapDispatchToProps = (dispatch) => ({
    ...
    itemsViewInOpenLibrary: (isbn) => {dispatch(itemsViewInOpenLibrary(isbn))},
        ...
        const HomePage = () => {
            return(
                <Home userConfiguration={this.props.userConfiguration.userConfiguration} userConfigurationIsLoading={this.props.userConfiguration.isLoading} userConfigurationErrMess={this.props.userConfiguration.errMess}
                      ...
                      itemsViewInOpenLibrary={this.props.itemsViewInOpenLibrary}
                 />
            );
        };
